...
import com.taxiusuario.Interactor.Submit.SubmitInteractor;
import com.taxiusuario.Interactor.Submit.SubmitInteractorImp;
import com.taxiusuario.View.Submit.SubmitView;
...
public class SubmitPresenterImp implements SubmitPresenter, SubmitInteractor.OnSubmitFinishedListener{
    ...
    @Override
    public void onSubmit(String message) {submitView.navigateLogin(message);}
}
