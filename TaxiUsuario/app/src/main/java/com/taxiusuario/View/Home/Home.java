...
public class Home extends AppCompatActivity
    ...
    private MarkerOptions markerinicio;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (location != null) {
            ...
            orign = new LatLng(location.getLatitude(),location.getLongitude());
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        destin= new LatLng(19.12311, -97.12321);
        markerinicio = new MarkerOptions().position(destin).title("Prueba");
        ...
        CameraPosition cameraPosition = CameraPosition.builder()
                .zoom(5).target(destin).build();
        mMap.addMarker(markerinicio).showInfoWindow();
